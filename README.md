...
1. [mahit2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahit2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahit2024.git
```
